...
### 临床医学学习指南
- **临床思维培养**：CBL、PBL、假设-演绎推理、鉴别诊断、Murtagh框架
- **病史采集与体格检查**：SOAP框架、视触叩听要点
- **辅助检查判读**：化验单、心电图速读、影像阅片顺序
- **常见病诊疗思路**：胸痛、腹痛、头痛、发热、呼吸困难的鉴别
- **临床轮转学习法**：入科准备 → 床旁学习 → 技能操作 → 病例整理 → 出科总结
- **循证医学入门**：证据等级金字塔、PICOS提问法
- **医学文献阅读**：三步阅读法、批判性评价
- **临床沟通技巧**：SPIKES原则、知情同意、坏消息告知
- **临床统计实战**：生存分析、t检验、ROC曲线（可交互运行R代码）
...
- **2026-06-26**: 新增临床医学学习指南板块（临床思维、病史采集、辅助检查、诊疗思路、轮转学习法、循证医学、文献阅读、临床沟通）
- **2026-06-26**: 新增论文写作方法板块（IMRaD结构、写作技巧、文献管理、图表规范、检查清单）
- **2026-06-26**: 初始版本上线，包含R语言交互学习和LaTeX实时预览功能
